...
{CLR3-- Added Runic Tablet Support:}
--- Increased Damage and 
Knockback of Soul of Edith's stomp
{CLR3-- Revamped EID support (WIP):}
...
-- General vector math 
optimization
-- Fixed Edith/T. Edith's 
Greedier unlock function 
triggering for other players
-- Added Ludovico's 
Stomp/Parry synergy
-- Improved Edith/T. Edith 
costume giver function
-- Removed an unused variable
-- Moved both Vestige and 
Grudge unlock methods to 
UnlockManager.lua
-- Improved Rep+ 
detection message
-- Remade Stomp's 
pickup grab system:
--- Cards/runes, pills and 
 trinkets can be taken 
 again with this
--- Now Edith must land as 
close as possible to a shop 
item to buy it
--- Fixed an error that caused 
Edith to lose her body for a 
moment when trying to grab 
two cards/runes/pills/trinkets 
at once

{{FSIZE2}}{CLR3- Edith:}
-- Fixed Edith triggering 
stomp synergies when going 
trough a trapdoor

{{FSIZE2}}{CLR3- Items:}
-- Fixed Salt Shaker push 
area persisting between rooms
{CLR3-- Effigy:}
--- Now a player in effigy 
state won't be affected by 
slipperyness
--- Now a player in effigy 
state will be less dragged 
by water currents
--- Now a player in effigy 
state won't receive damage 
from creep and spikes
--- Now a player in effigy 
state won't get damage by 
destroying a spiked rock 
with a stomp
Added Judas' Birthright 
interaction for Effigy
--- Fixed Effigy consuming 
more charges than intended 
with non-Edith Characters
--- Fixed Effigy triggering 
its effects when falling 
to a pitfall

{{FSIZE2}}{CLR3- Trinkets:}
-- Rumbling Pebble changes:
--- Increased rock scattering 
spread
--- Now Edith stomps/ T. Edith 
hops can trigger rock scattering
]])

DeadSeaScrollsMenu.AddChangelog("Edith: Rebuilt", "v1.8.2a", [[
...
{{FSIZE2}}{CLR3- Tainted Edith:}
-- Improved Status effect 
stomp/parry synergies

{{FSIZE2}}{CLR3- Stomp/Parry:}
{{FSIZE2}}{CLR3- Synergies:}
-- Improved Edith's 
...
{{FSIZE3}}Cinder Parries
{{FSIZE3}}update

{{FSIZE2}}{CLR3- Tainted Edith rework:}
-- Increased Perfect 
Parry radius (12 > 18)
-- Increased Imprecise 
Parry radius (35 > 45)
...
{{FSIZE3}}Salt Refinement
{{FSIZE3}}update Part II
